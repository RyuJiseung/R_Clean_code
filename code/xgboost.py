...
def DO(frm,to,fileno):
    ...
    train_df = do_countuniq( train_df, ['ip', 'day'], 'in_test_hh' ); gc.collect()
    ...
    train_df = do_count( train_df, ['ip', 'day', 'in_test_hh'] ); gc.collect()
    ...
    train_df = do_var( train_df, ['ip', 'app', 'os'], 'in_test_hh'); gc.collect()
    ...
    word= ['app','device','os', 'channel', 'in_test_hh']
    for feature in word:
        if feature not in predictors:
            predictors.append(feature)
    categorical = ['app', 'device', 'os', 'channel', 'in_test_hh']
